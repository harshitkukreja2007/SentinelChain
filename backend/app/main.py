...
# Enable CORS for Next.js frontend (local dev and Vercel deployment)
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:3000",
        ...
        "http://localhost:3001",
        "http://127.0.0.1:3001",
        "https://sentinel-chain-phi.vercel.app",
        "https://sentinel-chain-phi.vercel.app/",
    ],
    allow_origin_regex=r"https://sentinel-chain-.*\.vercel\.app",
